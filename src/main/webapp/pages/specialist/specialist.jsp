...
<div class="max-w-7xl mx-auto p-6">
    <div class="bg-white rounded-lg shadow-md p-6 mb-6 mt-32">
          <div class="flex justify-between items-start mb-4">
            <h2 class="text-2xl font-bold text-gray-800">Specialist Profile</h2>
            <div class="flex space-x-3">
                <button onclick="showModal('viewTimeSlots')" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
                      View time slots
                </button>
 ...
 <!-- EDIT Specialist MODAL -->
  ...
  <div id="viewTimeSlots" class="modal hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form action="${pageContext.request.contextPath}/specialist/time-slots" method="get">
          ...
          <div class="flex space-x-2">
            <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded flex-1 hover:bg-green-600">View</button>
            <button type="button" onclick="hideModal('viewTimeSlots')" class="bg-gray-300 px-4 py-2 rounded flex-1 hover:bg-gray-400">Cancel</button>
          </div>
        </form>
      </div>
    </div>
